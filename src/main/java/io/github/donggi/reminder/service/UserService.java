...
public class UserService {
    ...
    public UserLoginResponse register(UserLoginRequest request) {
        ...
        TUserSession tUserSession = userLogic.registerSession(tUser, request.getAlwaysLogin(), request.getAlwaysLogout());
    ...
    public UserLoginResponse login(UserLoginRequest request) {
        ...
        if (tryAutoLogin) {
            ...
            TUserSession tUserSession = userLogic.refreshSession(tUser, request.getRequestToken(), request.getAlwaysLogin(), request.getAlwaysLogout());
